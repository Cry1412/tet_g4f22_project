...
window.LEVEL_CONFIG = [

	{
		...
		key: { x: 180, y: 180 },
		circles: [
			{ x: 150, y: 230, radius: 30 },
			{ x: 125, y: 195, radius: 30 },
			{ "x": 100, "y": 160, "radius": 30 },
			{ "x": 125, "y": 125, "radius": 30 },
			{ "x": 150, "y": 90, "radius": 20 },
			{ "x": 175, "y": 90, "radius": 20 },
			{ "x": 200, "y": 90, "radius": 20 },
			{ "x": 225, "y": 90, "radius": 20 },
			{ "x": 250, "y": 90, "radius": 20 },
			{ "x": 275, "y": 90, "radius": 20 },
			{ "x": 300, "y": 90, "radius": 20 },
			{ "x": 200, "y": 230, "radius": 30 }
